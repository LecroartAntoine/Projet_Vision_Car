...
# Le modèle est stocké dans l'état de l'application pour être accessible par les endpoints.
# L'événement "startup" garantit que le modèle n'est chargé qu'une seule fois.
